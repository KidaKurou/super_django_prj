...
class TestOneDB(TestCase):
    ...
    def setUpTestData(cls):
        cls.ingredient_egg = Ingredient.objects.create(name=cls.INGREDIENT_NAME, weight=10, weight_ready=10, price=10)
        cls.recipe = Recipe.objects.create(title=cls.RECIPE_TITLE, description="Яичница", cooking_time=timedelta(minutes=10), image="Egg", ingredients=[cls.ingredient_egg])
...
class TestCatalog(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.recipe = Recipe.objects.create(title=cls.RECIPE_TITLE, description="Яичница", cooking_time=timedelta(minutes=10), image="Egg")
